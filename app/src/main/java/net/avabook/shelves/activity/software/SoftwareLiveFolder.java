...
package net.avabook.shelves.activity.software;
...
public class SoftwareLiveFolder extends Activity {
	public static final Uri CONTENT_URI = Uri
			.parse("content://SoftwareProvider/live_folders/software");
		...
		if (LiveFolders.ACTION_CREATE_LIVE_FOLDER.equals(action)) {
			setResult(
					...
					createLiveFolder(this, CONTENT_URI,
							getString(R.string.live_folder_software),
	...
	private static Intent createLiveFolder(Context context, Uri uri,
		...
		intent.putExtra(LiveFolders.EXTRA_LIVE_FOLDER_BASE_INTENT, new Intent(
				Intent.ACTION_VIEW, SoftwareStore.Software.CONTENT_URI));
