...
public interface AuthManager {
	 ...
	 * haven't already. The {@link AuthCallback} provided will be executed when
	 * the auth token fetching is done (successfully or not).
	 * 
	 * @param whenFinished
	 *            A {@link AuthCallback} to execute when the auth token fetching
	 *            is done
	 */
	 ...
	 * {@link android.app.Activity#onActivityResult} function. This function
	 * will return true if an auth token was successfully fetched or the process
	 * is not finished.
	 * 
	 * @param resultCode
	 *            The result code passed in to the {@link android.app.Activity}
	 *            's {@link android.app.Activity#onActivityResult} function
	 * @param results
	 *            The data passed in to the {@link android.app.Activity}'s
